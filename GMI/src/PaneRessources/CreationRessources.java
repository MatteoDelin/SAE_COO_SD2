...
public class CreationRessources extends JPanel {
    ...
    public CreationRessources() {
        ...
        String placeholder = "Enter ressource name";
        ...
        TextName.addFocusListener(new FocusListener() {
            @Override public void focusGained(FocusEvent e) {
                if (TextName.getText().equals("Ressource name")) {
                    TextName.setText(""); TextName.setForeground(Color.BLACK);
                }
            }
            @Override public void focusLost(FocusEvent e) {
                if (TextName.getText().isEmpty()) {
                    TextName.setText("Ressource name"); TextName.setForeground(Color.GRAY);
                }
            }
        });
